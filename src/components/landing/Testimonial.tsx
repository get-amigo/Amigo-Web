    ...
    <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      <div className="mb-12 md:mb-0">
        <div className="mb-6 flex justify-center">
          <img src="https://wellfound.com/cdn-cgi/image/width=400,height=400,format=auto,fit=cover/https://photos.wellfound.com/users/13206292-original?1657471229"
            className="w-32 rounded-full shadow-lg dark:shadow-black/20" />
        </div>
        <h5 className="mb-2 text-lg font-bold">	Bhaumik Tandan</h5>
